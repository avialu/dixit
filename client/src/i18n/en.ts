...
export const en: TranslationKeys = {
  ...
  lobby: {
    ...
    uploadBackgroundDesc: 'Upload an image to customize the game board background',
    ...
    spectatingHelp: 'Spectating - You can upload images to help build the deck!',
  ...
  deckUploader: {
    ...
    tooManyImagesMessage: 'You can only upload {remaining} more images. The first {remaining} images will be processed.',
  ...
  confirm: {
    ...
    makeAdminMessage: 'Make {name} the admin? You will become a regular player.',
    logoutWarningTitle: 'Logout Warning',
    logoutWarningMessage: 'You have {count} uploaded image(s) in the deck. If you logout, these images will be permanently removed from the game. Are you sure you want to logout?',
    deleteImageTitle: 'Delete Image',
    deleteImageMessage: 'Are you sure you want to delete this image from the deck?',
  },
